...
export function ImagePreview({ imageUrl, imageAlt = 'Image', open, onOpenChange }: ImagePreviewProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPortal>
        <DialogOverlay className="bg-black/80 z-[5009]" />
        <DialogPrimitive.Content className="fixed left-[50%] top-[50%] z-[5010] max-h-[90vh] w-[90vw] max-w-4xl translate-x-[-50%] translate-y-[-50%] overflow-auto rounded-lg bg-background p-6 shadow-lg">
          <DialogHeader>
