...
import { Loader2, Trash2, Check, CheckCheck } from 'lucide-react';
...
export function NotificationCenter() {
    ...
    return (
        <div className="space-y-4">
            {/* Toolbar */}
            <div className="flex flex-col gap-4 rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-950 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-2">
                    <Select value={filter} onValueChange={(value: 'all' | 'unread') => {
                        setFilter(value);
                        setPage(1);
                    }}>
